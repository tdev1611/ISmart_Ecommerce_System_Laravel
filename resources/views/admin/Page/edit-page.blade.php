            ...
            <div class="card-body">
                <form action="{{ url('admin/page/update', $page->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ $page->title }}" name="title" id="title"
                            placeholder="Tiêu đề">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" value="" name="content" id="content" cols="30" rows="5"
                            placeholder="Nội dung">{{ $page->content }}</textarea>
                        @error('content')
                            <div class="text-danger"> {{ $message }}</div>
                        @enderror
                    </div>
